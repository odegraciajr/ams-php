...
class AppBase
{
	...
	*/
	...
	{
		self::$_controller = str_replace("controller","",strtolower($_controller));
	}
	...
	public static function formatControllerName($ctrl)
	{
		return ucwords( str_replace("controller","",strtolower($ctrl)) ) . 'Controller';
	}
	
	public static function formatActionName($action)
	{
		return ucwords( str_replace("Action","",strtolower($action)) ) . 'Action';
	}
