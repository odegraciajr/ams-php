			...
			<div class="container">
				...
				<div id="bs-example-navbar-collapse-8" class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						<li <?php App::Tools()->setActiveNav($this->activeNav,'dashboard');?>><a href="<?php echo RouteManager::createUrl('/dashboard');?>">Dashboard</a></li>
						<li <?php App::Tools()->setActiveNav($this->activeNav,'profile');?>><a href="<?php echo RouteManager::createUrl('/account/');?>">Profile</a></li>
