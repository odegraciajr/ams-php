			...
			<div class="container">
				...
				<div id="bs-example-navbar-collapse-8" class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						<li <?php Helper::setActiveNav($this->active_nav,'dashboard');?>><a href="<?php echo RouteManager::createUrl('/dashboard');?>">Dashboard</a></li>
						<li <?php Helper::setActiveNav($this->active_nav,'profile');?>><a href="<?php echo RouteManager::createUrl('/account/home');?>">Profile</a></li>
						<li <?php Helper::setActiveNav($this->active_nav,'organization');?>>
						...
						<li <?php Helper::setActiveNav($this->active_nav,'project');?>>
